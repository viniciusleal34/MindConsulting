...
import { StyleSheet,Text, KeyboardAvoidingView, Image, View, FlatList,AsyncStorage, TouchableOpacity,Modal,TextInput} from 'react-native';
...
async function editarUser(item){
  ...
  const usuario = response.data.user
   await AsyncStorage.multiSet([
        ['@CodeApi:perfil', JSON.stringify(usuario)],
      ])
